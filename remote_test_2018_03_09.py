...
def ssh_send_cmd_switch(os, background_run,  PROGRAM_PATH , STRESS_CMD )
     if(os == os_linux):
...
def NM_WS_004_WIN(ipmi):
     ...
     os.system( WIN_BACKGROUND_RUN + WIN_SSH_PATH + os_user + '@' + os_ip_addr +' -t sudo ' + centos_reset + ' &')
...
def DC_CYCLE(ipmi):
     ...
     #ipmi.session.close()
     #ipmi = aardvark_ipmi_init(target_bmc_addr, target_bmc_bridge_channel)
     ipmi.target = pyipmi.Target(target_bmc_addr)
     target_routing = [(0x20,0)]
     ipmi.target.set_routing(target_routing)
     ...
     if(power_status == 1):
         ...
         os.system( WIN_BACKGROUND_RUN + WIN_SSH_PATH + os_user + '@' + os_ip_addr +' -t sudo ' + centos_dc_off + ' &')
...
ipmi = aardvark_ipmi_init(target_me_addr, target_me_bridge_channel)
#loop = 300
#sts = DC_CYCLE_LOOP_WIN(ipmi, loop)
#print(sts)
#////
#ipmi.session.close()
#ipmi = aardvark_ipmi_init(target_bmc_addr, target_bmc_bridge_channel)
#power_status = get_chassis_status_py(ipmi)
#print('power status = %d ' %power_status )
#ipmi.session.close()
#ipmi = aardvark_ipmi_init(target_me_addr, target_me_bridge_channel)
...
if(NM_TEST_STS[3] == SUCCESSFUL):
     print('NM_003 CPU Power Accuracy Test: Pass')
elif(NM_TEST_STS[3] == NONE):
     print('NM_003 Not Test')
else:
     print('NM_003 CPU Power Accuracy Test: Fail !!!')
     print('Please enable debug mode for more detail test information')
if(NM_TEST_STS[4] == SUCCESSFUL):
     print('NM_004 Memory Power Accuracy Test: Pass')
elif(NM_TEST_STS[4] == NONE):
     print('NM_004 Not Test')
else:
     print('NM_004 Memory Power Accuracy Test: Fail !!!')
     print('Please enable debug mode for more detail test information')
if(NM_TEST_STS[6] == SUCCESSFUL):
     print('NM_006 ME RTC TIME Accuracy Test: Pass')
elif(NM_TEST_STS[6] == NONE):
     print('NM_006 Not Test')
else:
     print('NM_006 ME RTC TIME Accuracy Test: Fail !!!')
     print('Please enable debug mode for more detail test information')
if(NM_TEST_STS[9] == SUCCESSFUL):
     print('NM_009 Platform Power Limit Test: Pass')
elif(NM_TEST_STS[9] == NONE):
     print('NM_009 Not Test')
else:
     print('NM_009 Platform Power Limit Test: Fail !!!')
     print('Please enable debug mode for more detail test information')
if(NM_TEST_STS[10] == SUCCESSFUL):
     print('NM_010 CPU Power Limit Test: Pass')
elif(NM_TEST_STS[10] == NONE):
     print('NM_010 Not Test')
else:
     print('NM_010 CPU Power Limit Test: Fail !!!')
     print('Please enable debug mode for more detail test information')
if(NM_TEST_STS[11] == SUCCESSFUL):
     print('NM_011 Memory Power Limit Test: Pass')
elif(NM_TEST_STS[11] == NONE):
     print('NM_011 Not Test')
else:
     print('NM_011 Memory Power Limit Test: Fail !!!')
     print('Please enable debug mode for more detail test information')
if(NM_TEST_STS[19] == SUCCESSFUL):
     print('PECI_004 PECI PROXY Test: Pass')
elif(NM_TEST_STS[19] == NONE):
     print('PECI_004 Not Test')
else:
     print('PECI_004 PECI PROXY Test: Fail !!!')
     print('Please enable debug mode for more detail test information')

if(NM_TEST_STS[7] == SUCCESSFUL):
     print('NM_007 PECI PROXY Test: Pass')
elif(NM_TEST_STS[7] == NONE):
     print('NM_007 Not Test')
else:
     print('NM_007 Set P/T state Test: Fail !!!')
     print('Please enable debug mode for more detail test information')

if(NM_TEST_STS[14] == SUCCESSFUL):
     print('NM_014 Fast NM Limiting Test: Pass')
elif(NM_TEST_STS[14] == NONE):
     print('NM_014 Not Test')
else:
     print('NM_014 Fast NM Limiting Test: Fail !!!')
     print('Please enable debug mode for more detail test information')


if(NM_TEST_STS[30] == SUCCESSFUL):
     print('SMART_001 SMART/CLST  Test: Pass')
elif(NM_TEST_STS[30] == NONE):
     print('SMART_001 Not Test')
else:
     print('SMART_001 Fast NM Limiting Test: Fail !!!')
     print('Please enable debug mode for more detail test information')

if(NM_TEST_STS[31] == SUCCESSFUL):
     print('PM_002  Missing Power Reading Test: Pass')
elif(NM_TEST_STS[31] == NONE):
     print('PM_002 Not Test')
else:
     print('PM_002  Missing Power Reading Test: Fail !!!')
     print('Please enable debug mode for more detail test information')

if(NM_TEST_STS[32] == SUCCESSFUL):
     print('PM_003  Set Total Power Budget Test: Pass')
elif(NM_TEST_STS[32] == NONE):
     print('PM_003 Not Test')
else:
     print('PM_003  Set Total Power Budget Test: Fail !!!')
     print('Please enable debug mode for more detail test information')

if(NM_TEST_STS[33] == SUCCESSFUL):
     print('PM_004  Set Power Draw Range Test: Pass')
elif(NM_TEST_STS[33] == NONE):
     print('PM_004 Not Test')
else:
     print('PM_004  Set Power Draw Range Test: Fail !!!')
     print('Please enable debug mode for more detail test information')

if(NM_TEST_STS[34] == SUCCESSFUL):
     print('PM_005  DC Power Test: Pass')
elif(NM_TEST_STS[34] == NONE):
     print('PM_005 Not Test')
else:
     print('PM_005  DC Power Test: Fail !!!')
     print('Please enable debug mode for more detail test information')

if(NM_TEST_STS[35] == SUCCESSFUL):
     print('PM_006  DC Power Test: Pass')
elif(NM_TEST_STS[35] == NONE):
     print('PM_006 Not Test')
else:
     print('PM_006  DC Power Test: Fail !!!')
     print('Please enable debug mode for more detail test information')


if(NM_TEST_STS[36] == SUCCESSFUL):
     print('DC_CYCLE TEST: Pass')
elif(NM_TEST_STS[36] == NONE):
     print('DC_CYCLE TEST Not Test')
else:
     print('DC_CYCLE TEST  : Fail !!!')
     print('Please enable debug mode for more detail test information')
     
if(NM_TEST_STS[37] == SUCCESSFUL):
     print(' RESET_CYCLE TEST: Pass')
elif(NM_TEST_STS[37] == NONE):
     print('RESET_CYCLE TEST Not Test')
else:
     print('RESET_CYCLE TEST  : Fail !!!')
     print('Please enable debug mode for more detail test information')

if(NM_TEST_STS[41] == SUCCESSFUL):
     print('MCTP_004: Pass')
elif(NM_TEST_STS[41] == NONE):
     print('MCTP_004 TEST Not Test')
else:
     print('MCTP_004 TEST  : Fail !!!')
     print('Please enable debug mode for more detail test information')

if(NM_TEST_STS[48] == SUCCESSFUL):
     print('PTU_003: Pass')
elif(NM_TEST_STS[38] == NONE):
     print('PTU_003 TEST Not Test')
else:
     print('PTU_003 TEST  : Fail !!!')
     print('Please enable debug mode for more detail test information')

if(NM_TEST_STS[53] == SUCCESSFUL):
     print('NM_WS_004: Pass')
elif(NM_TEST_STS[53] == NONE):
     print('NM_WS_004 TEST Not Test')
else:
     print('NM_WS_004 TEST  : Fail !!!')
     print('Please enable debug mode for more detail test information')
if(NM_TEST_STS[60] == SUCCESSFUL):
     print('PTT_003: Pass')
elif(NM_TEST_STS[60] == NONE):
     print('PTT_003 TEST Not Test')
else:
     print('PTT_003 TEST  : Fail !!!')
     print('Please enable debug mode for more detail test information')
if(NM_TEST_STS[61] == SUCCESSFUL):
     print('PTT_004: Pass')
elif(NM_TEST_STS[61] == NONE):
     print('PTT_004 TEST Not Test')
else:
     print('PTT_004 TEST  : Fail !!!')
     print('Please enable debug mode for more detail test information')
if(NM_TEST_STS[62] == SUCCESSFUL):
     print('BTG_003: Pass')
elif(NM_TEST_STS[62] == NONE):
     print('BTG_003 TEST Not Test')
else:
     print('BTG_003 TEST  : Fail !!!')
     print('Please enable debug mode for more detail test information')
